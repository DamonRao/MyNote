...
@interface TCSimpleNoteViewController ()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate>
...
- (void)viewDidLoad
{
    ...
    //列表
    UITableView * simpleTable = [[UITableView alloc]initWithFrame:CGRectMake(0,topMargin, self.view.frame.size.width,self.view.frame.size.height-topMargin-tabbarMargin) style:UITableViewStylePlain];
    simpleTable.separatorStyle = UITableViewCellSeparatorStyleNone;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0)
    {
        cell.textLabel.textColor=[DHDeviceUtil colorWithHexString:@"#111111"];
        cell.textLabel.font = [UIFont boldSystemFontOfSize:18];
    }
    else
    {
        cell.textLabel.textColor=[DHDeviceUtil colorWithHexString:@"#666666"];
...
-(void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (editingStyle == UITableViewCellEditingStyleInsert)
    {
        ...
        //更改列表文字
        [[self.TCnote.datas objectAtIndex:0] insertObject:LocalString(@"NewSNote") atIndex:[indexPath row] + 1 ];
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    colorView.backgroundColor = [DHDeviceUtil colorWithHexString:@"#eeeeee"];
    return colorView;
}
